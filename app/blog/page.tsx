...
export default async function BlogIndexPage() {
  ...
  return (
    <>
    <Home/>
    <div className="w-full mx-auto flex flex-col gap-1 sm:min-h-[91vh] min-h-[88vh] pt-2" id="blogs">
...
function BlogCard({
  ...
  return (
    ...
    >
      <h3 className="text-md font-semibold -mt-1 pr-7 font-roboto">{title}</h3>
      <div className="w-full hover:shadow-xl rounded" >
        <Image
          src={cover}
          alt={title}
          width={400}
